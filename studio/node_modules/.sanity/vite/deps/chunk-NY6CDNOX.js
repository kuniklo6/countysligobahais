...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-3K3LARF4.js")
});
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$H), filter(t32), map(_temp2$i)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = (0, import_react2.useState)(_temp$G);
  let t2;
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$F), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function DocumentNotInReleaseBanner(t0) {
  ...
  const tone = t2, {
    ...
    createVersion
  } = useVersionOperations(), isAnonymousBundle = typeof currentRelease == "string", [versionCreateState, setVersionCreateState] = (0, import_react2.useState)(), toast = useToast();
  let t32;
  ...
  let t12;
  $[27] !== t3 || $[28] !== t11 || $[29] !== t9 ? (t12 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "banners.release.not-in-release", t: t3, values: t9, components: t11 }) }), $[27] = t3, $[28] = t11, $[29] = t9, $[30] = t12) : t12 = $[30];
  let t13;
  ...
  let t14;
  return $[37] !== t12 || $[38] !== t13 || $[39] !== tone ? (t14 = (0, import_jsx_runtime2.jsx)(Banner, { tone, content: t12, action: t13 }), $[37] = t12, $[38] = t13, $[39] = tone, $[40] = t14) : t14 = $[40], t14;
}
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(77), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$y), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
...
var DocumentPanel = function(props) {
  ...
  bb1: {
    ...
    if (isPausedDraft && displayed?._id) {
      let t153;
      $[52] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t153 = (0, import_jsx_runtime2.jsx)(PausedScheduledDraftBanner, {}), $[52] = t153) : t153 = $[52], t12 = t153;
      break bb1;
    }
    if (documentInScheduledRelease) {
      const t153 = selectedPerspective;
      let t163;
      $[53] !== t153 ? (t163 = (0, import_jsx_runtime2.jsx)(ScheduledReleaseBanner, { currentRelease: t153 }), $[53] = t153, $[54] = t163) : t163 = $[54], t12 = t163;
      break bb1;
    }
    let t152;
    ...
    if (selectedPerspective === "drafts" && scheduledCardinalityOneRelease && displayedIsDraft) {
      let t163;
      $[58] !== displayed || $[59] !== scheduledCardinalityOneRelease._id ? (t163 = (0, import_jsx_runtime2.jsx)(ScheduledDraftOverrideBanner, { releaseId: scheduledCardinalityOneRelease._id, draftDocument: displayed }), $[58] = displayed, $[59] = scheduledCardinalityOneRelease._id, $[60] = t163) : t163 = $[60], t12 = t163;
      break bb1;
    }
    let t162;
    ...
    if (!isSystemBundle(selectedPerspective) && displayed?._id && getVersionFromId(displayed._id) !== selectedPerspectiveName && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === false && !isCurrentVersionGoingToUnpublish) {
      let t172;
      $[63] !== isScheduledRelease || $[64] !== selectedPerspective || $[65] !== value._id ? (t172 = (0, import_jsx_runtime2.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: selectedPerspective, isScheduledRelease }), $[63] = isScheduledRelease, $[64] = selectedPerspective, $[65] = value._id, $[66] = t172) : t172 = $[66], t12 = t172;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t172;
        $[67] !== displayed || $[68] !== documentId || $[69] !== schemaType ? (t172 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[67] = displayed, $[68] = documentId, $[69] = schemaType, $[70] = t172) : t172 = $[70], t12 = t172;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t172;
        $[71] !== displayed || $[72] !== documentId || $[73] !== schemaType ? (t172 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: true }), $[71] = displayed, $[72] = documentId, $[73] = schemaType, $[74] = t172) : t172 = $[74], t12 = t172;
        break bb1;
      }
    }
    ...
    let t17;
    $[75] !== showCreateBanner ? (t17 = showCreateBanner && (0, import_jsx_runtime2.jsx)(CreateLinkedBanner, {}), $[75] = showCreateBanner, $[76] = t17) : t17 = $[76];
    let t18;
    $[77] !== permissions?.granted || $[78] !== requiredPermission ? (t18 = !permissions?.granted && (0, import_jsx_runtime2.jsx)(InsufficientPermissionBanner, { requiredPermission }), $[77] = permissions?.granted, $[78] = requiredPermission, $[79] = t18) : t18 = $[79];
    let t19, t20, t21, t22, t23, t24;
    $[80] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t19 = (0, import_jsx_runtime2.jsx)(RevisionNotFoundBanner, {}), t20 = (0, import_jsx_runtime2.jsx)(ReferenceChangedBanner, {}), t21 = (0, import_jsx_runtime2.jsx)(DeprecatedDocumentTypeBanner, {}), t22 = (0, import_jsx_runtime2.jsx)(CanvasLinkedBanner, {}), t23 = (0, import_jsx_runtime2.jsx)(DeletedDocumentBanners, {}), t24 = (0, import_jsx_runtime2.jsx)(UnpublishedDocumentBanner, {}), $[80] = t19, $[81] = t20, $[82] = t21, $[83] = t22, $[84] = t23, $[85] = t24) : (t19 = $[80], t20 = $[81], t21 = $[82], t22 = $[83], t23 = $[84], t24 = $[85]);
    const t25 = displayed?._id ?? documentId;
    let t26;
    $[86] !== isPinnedDraftOrPublish || $[87] !== t25 ? (t26 = (0, import_jsx_runtime2.jsx)(OpenReleaseToEditBanner, { documentId: t25, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[86] = isPinnedDraftOrPublish, $[87] = t25, $[88] = t26) : t26 = $[88];
    let t27;
    $[89] !== t17 || $[90] !== t18 || $[91] !== t26 ? (t27 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      t17,
      t18,
      t19,
      t20,
  ...
  let t14;
  $[95] !== activeViewNode || $[96] !== banners || $[97] !== documentScrollElement || $[98] !== footer || $[99] !== formViewHidden || $[100] !== inspectDialog || $[101] !== layoutCollapsed || $[102] !== margins || $[103] !== portalElement || $[104] !== portalElements || $[105] !== showFormView ? (t14 = showFormView && (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t15;
  $[107] !== documentId || $[108] !== rootElement || $[109] !== schemaType || $[110] !== showInspector ? (t15 = showInspector && (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: rootElement, children: (0, import_jsx_runtime2.jsx)(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[107] = documentId, $[108] = rootElement, $[109] = schemaType, $[110] = showInspector, $[111] = t15) : t15 = $[111];
  let t16;
  return $[112] !== t14 || $[113] !== t15 ? (t16 = (0, import_jsx_runtime2.jsx)(PaneContent, { children: (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", children: [
    t14,
    t15
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./index2-C3DD52KF.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index3-LJN74UA7.js"))
};
...
function ChangesTabs(props) {
  ...
  let t24;
  $[51] !== t20 || $[52] !== t23 ? (t24 = (0, import_jsx_runtime2.jsx)(Card, { padding: 2, marginBottom: 3, marginX: 3, tone: "neutral", border: true, radius: 3, children: (0, import_jsx_runtime2.jsxs)(Flex, { gap: 2, align: "flex-start", children: [
    t20,
    t23
  ...
  let t31;
  return $[66] !== t17 || $[67] !== t22 || $[68] !== t24 || $[69] !== t27 || $[70] !== t30 ? (t31 = (0, import_jsx_runtime2.jsxs)(FadeInFlex, { direction: "column", padding: 0, height: "fill", "data-ready": t22, ref: setParentRef, children: [
    t17,
    t24,
    t27,
    t30
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index4-APQ3ZX6E.js")),
...
//# sourceMappingURL=chunk-NY6CDNOX.js.map
