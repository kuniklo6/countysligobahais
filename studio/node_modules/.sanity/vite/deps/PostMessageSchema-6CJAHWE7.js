...
// node_modules/sanity/lib/_chunks-es/PostMessageSchema.js
...
function isFieldRequired(field) {
  ...
  for (const rule of rules) {
    ...
    const proxy = new Proxy({}, {
      get: (target, methodName) => () => (methodName === "required" && (required = true), proxy)
    });
...
function SchemaIcon(t0) {
  ...
  let t1;
  return $[0] !== Icon ? (t1 = Icon ? (0, import_react.isValidElement)(Icon) ? Icon : (0, import_jsx_runtime.jsx)(Icon, {}) : null, $[0] = Icon, $[1] = t1) : t1 = $[1], t1;
}
var documentDefaultFields = (typeName) => ({
  _id: {
    type: "objectField",
    name: "_id",
    value: {
...
function createReferenceNode(name, inArray = false) {
  const fields = {
    _ref: {
      type: "objectField",
      name: "_ref",
...
var typesMap = /* @__PURE__ */ new Map([["text", {
  type: "string"
}], ["url", {
  type: "string"
}], ["datetime", {
...
function extractSchema(workspace) {
  ...
  function extractIcon(schemaType) {
    if (schemaType.icon)
      return (0, import_server.renderToString)((0, import_jsx_runtime.jsx)(SchemaIcon, { schemaType }));
  }
...
function PostMessageSchema(props) {
  ...
  }, t1 = [comlink, workspace], $[0] = comlink, $[1] = workspace, $[2] = t0, $[3] = t1) : (t0 = $[2], t1 = $[3]), (0, import_react.useEffect)(t0, t1);
  let t2;
  ...
  }), t4 = [comlink, client, perspective], $[6] = client, $[7] = comlink, $[8] = perspective, $[9] = t3, $[10] = t4) : (t3 = $[9], t4 = $[10]), (0, import_react.useEffect)(t3, t4), null;
}
function _temp2(t0) {
  const {
    path: path_1,
...
var PostMessageSchema_default = (0, import_react.memo)(PostMessageSchema);
export {
  PostMessageSchema_default as default
};
//# sourceMappingURL=PostMessageSchema-6CJAHWE7.js.map
